...
import (
	...
	"github.com/Nicolas-Ignacio-Bouffanais/microservicio_alertas/internal/services/zona_roja"
...
func main() {
	...
	runner.RunService("ZonaRoja", zona_roja.ProcesarEventosZonaRoja, frecuencia, true)
}
